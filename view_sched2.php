...
<div role="tabpanel" class="tab-content bg-base-100 border-base-300 rounded-box p-6">
    ...
    <form id="update">
        ...
        <div class="input-bordered flex items-center gap-2 mb-3" id="cancelDateField" style="display: none;">
            <div class="input-group-text">
                <span class="">Cancelled Date</span>
            </div>
            <input type="datetime-local" class="form-control" id="cancelled" name="cancelled" value="<?php echo $schedule; ?>">
        </div>
