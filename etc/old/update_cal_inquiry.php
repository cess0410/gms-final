...
<section class="main_content dashboard_part large_header_bg">
    <div class="main_content_iner ">
        ...
        <input type='datetime-local' class='form-control form-control-sm rounded-0' style='font-size: 16px' name='start_datetime' id='start_datetime' value='" . $start_datetime . "'>
                     ...
                     <button type="submit" class="btn_1" name="action" value="update"><i class="fas fa-save"></i></button>
                    <a class="btn_1" onclick="window.history.back();"><i class="fa fa-window-close"></i></a>
                </div>
                            </form> ';
                                    }
                                }
